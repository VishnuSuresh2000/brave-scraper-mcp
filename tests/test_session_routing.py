...
class TestSessionIDRouting:
    ...
    @pytest.mark.asyncio
    async def test_brave_search_without_session_id_uses_shared_browser(self, mock_browser_manager):
    ...
    @pytest.mark.asyncio
    async def test_brave_search_with_session_id_uses_subagent_browser(self, mock_browser_manager):
    ...
    @pytest.mark.asyncio
    async def test_brave_extract_without_session_id_uses_shared_browser(self, mock_browser_manager):
